    ...
    <div className='nbod1 w-screen h-16 flex bg-white px-8 items-center justify-between fixed z-10'>
      ...
      <div className='flex justify-between items-center gap-10'>
        ...
        <div className='flex items-center relative'>
          ...
          {filteredData.length != 0 &&
            <div className='dataResult fixed top-14 bg-white max-h-[80vh] border rounded-lg w-[400px]' >
              {filteredData.slice(0, 10).map(value => (
                <div onClick={()=>{
                  ...
                  <span>{value.name} {value.username}</span>
      ...
      <div>
        <div className='flex gap-4'>
          ...
          <NavLink><div className='bg-gray-200 p-2 hovertext' data-hover='Notifications' style={{ borderRadius: '50%' }}><BiBell className='text-3xl' /></div></NavLink>
