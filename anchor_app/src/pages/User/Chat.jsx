...
function Chat() {
    ...
    return (
        <>
            <Navbar />
            <Sidebar/>
            <div className='pt-16 pl-64 min-h-screen flex bg-[#fafafa] '>
            <div className='flex mx-10 my-2 rounded-md px-7 border border-zinc-300 bg-white w-full h-[88vh]' >
                <div className="Chat w-full">
                    ...
                    <div className="Right-side-chat">
                        {/* chat body */}
                        <Chatbox chat={currentChat} currentUser={user[0]._id} setSendMessage={setSendMessage} receivedMessage={receivedMessage} />
                    </div>
                </div>
            </div>
            </div>
